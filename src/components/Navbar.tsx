  ...
  return (
    <>
      <nav className="border-b">
        <div className="max-w-7xl mx-auto flex items-center justify-between py-4 border-b">
          <div className="">
            <Link className="" href="/">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xl font-bold uppercase tracking-tighter text-primary-500">Cook-Books</span>
              </div>
            </Link>
          </div>
